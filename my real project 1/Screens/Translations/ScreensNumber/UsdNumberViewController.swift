...
class UsdNumberViewController: UIViewController, ValidateProtocol2 {
    ...
    private func upperPartScreen() {
        ...
        myTransferBT.addTarget(self, action: #selector(transUSD), for: .touchUpInside)
    ...
    @objc func transUSD(_ sender: UIButton) {
