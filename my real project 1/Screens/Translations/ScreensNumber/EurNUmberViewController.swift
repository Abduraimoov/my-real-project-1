...
class EurNUmberViewController: UIViewController, ValidateProtocol2 {
    ...
    private func upperPartScreen() {
        ...
        myTransferBT.addTarget(self, action: #selector(transEur), for: .touchUpInside)
    ...
    @objc func transEur(_ sender: UIButton) {
