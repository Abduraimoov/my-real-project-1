...
class EurNUmberViewController: UIViewController {
    ...
    private func upperPartScreen() {
        ...
        myTransferBT.addTarget(self, action: #selector(transferButton2), for: .touchUpInside)
    }
    ...
    @objc func transferButton2(_ sender: UIButton) {
