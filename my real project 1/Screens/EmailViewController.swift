...
class EmailViewController: UIViewController {
    ...
    private func upperPartScreen() {
        ...
        ButtonTraelingInStactVW.addTarget(self, action: #selector(emailTapped), for: .touchUpInside)
        ...
        myRegisterView.addSubview(myEmailTF)
        
        NSLayoutConstraint.activate([
            myEmailTF.topAnchor.constraint(equalTo: myLabelView2.bottomAnchor, constant: 19),
            myEmailTF.leadingAnchor.constraint(equalTo: myRegisterView.leadingAnchor, constant: 18),
            myEmailTF.trailingAnchor.constraint(equalTo: myRegisterView.trailingAnchor, constant: -16),
            myEmailTF.heightAnchor.constraint(equalToConstant: 40)
        ])
        myRegisterView.addSubview(btGetOpt)
        NSLayoutConstraint.activate([
            btGetOpt.topAnchor.constraint(equalTo: myEmailTF.bottomAnchor, constant: 35),
    ...
    @objc func secondView(sender: UIButton) {
        if emailKGZ() {
            ...
            myEmailTF.placeholder = "Введите почту с @gmail.com"
